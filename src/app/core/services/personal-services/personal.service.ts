...
import { userInterface, rootInterface } from "../../../login/model/login.interface"
@Injectable({
  providedIn: "root",
})
export class PersonalService {
  ...
  getPersonal(): Observable<Personal[]> {
    return this.http.get<Personal[]>(`${this.base_url}/${this.bd}/personal`);
  }
  ...
  editPersonal(personal): Observable<Personal> {
    return this.http.put<any>(`${this.base_url}/${this.bd}/personal`, personal);
  }
  ...
  getPidePersonalData(nroDoc: string) {
    return this.http
      .get<any>(`${this.base_url}/${this.bd}/pide/consultar/${nroDoc}`)
      .toPromise()
      .then((res) => <any>res)
      .then((data) => {
        return data;
