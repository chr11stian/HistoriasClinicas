...
import {ReproCitasService} from "../../cred/services/repro-citas.service";
...
@Component({
    selector: 'app-dialog-citas',
    templateUrl: './dialog-citas.component.html',
    styleUrls: ['./dialog-citas.component.css']
})
