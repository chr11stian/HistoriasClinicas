...
export class IntervaloDialogoComponent implements OnInit {
    ...
    llenarCamposEdicionIntervalo() {
        ...
        this.form.get('vomitosFrecuentes').setValue(configuracion.items[6].valor === "true" ? ["true"] : []);
        this.form.get('palidez').setValue(configuracion.items[7].valor === "true" ? ["true"] : []);
        this.form.get('calentura').setValue(configuracion.items[8].valor === "true" ? ["true"] : []);
        this.form.get('dolorCabeza').setValue(configuracion.items[9].valor === "true" ? ["true"] : []);
        this.form.get('hinchazon').setValue(configuracion.items[10].valor === "true" ? ["true"] : []);
        this.form.get('dolores').setValue(configuracion.items[11].valor === "true" ? ["true"] : []);
        this.form.get('movimientoBebe').setValue(configuracion.items[12].valor === "true" ? ["true"] : []);
        this.form.get('malAcomodado').setValue(configuracion.items[13].valor === "true" ? ["true"] : []);
        this.form.get('perdidaLiquidos').setValue(configuracion.items[14].valor === "true" ? ["true"] : []);
