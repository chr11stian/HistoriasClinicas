...
@Component({
  selector: 'app-tratamiento-general',
  templateUrl: './tratamiento-general.component.html',
  styleUrls: ['./tratamiento-general.component.css']
})
export class TratamientoGeneralComponent implements OnInit {
