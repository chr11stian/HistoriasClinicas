...
@Component({
  selector: 'app-dialog-solicitud-img',
  templateUrl: './dialog-solicitud-img.component.html',
  styleUrls: ['./dialog-solicitud-img.component.css']
})
export class DialogSolicitudImgComponent implements OnInit {
  ...
  async enviarSolicitudEcografia() {
    ...
    var data = {
      ...
      cie10SIS: this.formEcografiaSolicitud.value.SISCIE.codigo,
      estadoPago: "PAGADO"
    }
