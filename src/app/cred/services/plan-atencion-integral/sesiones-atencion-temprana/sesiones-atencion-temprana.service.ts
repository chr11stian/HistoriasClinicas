...
import { SesionesTempranas} from '../../../models/plan-atencion-integral/plan-atencion-integral.model' 
...
export class SesionesAtencionTempranaService {
  ...
  addNuevaSesion(dni: string, nuevo: SesionesTempranas[]){
  ...
  updateSesion(dni: string, editado: SesionesTempranas[]){
    return this.http.put(`${this.base_url}/${this.bd}/cred/update_sesion_atencion_temprana/${dni}`,editado, {headers});
  }
}
