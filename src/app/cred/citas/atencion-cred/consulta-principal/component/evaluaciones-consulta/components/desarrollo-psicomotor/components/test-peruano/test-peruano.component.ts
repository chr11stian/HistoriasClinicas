...
export class TestPeruanoComponent implements OnInit {
  ...
  convetirX(letra_numero) {
    ...
    if (partes[0] === 'A'){return 1;
    }else{
      if(partes[0] === 'B'){return 2;}
      else{
        if(partes[0]==='C'){ return 3;}
        else{
          if(partes[0]==='D'){return 4;}
          else{
            if(partes[0]==='E'){return 5;}
            else{
              if(partes[0]==='F'){return 6;}
              else{
                if(partes[0]==='G'){return 7;}
                else{
                  if(partes[0]==='H'){return 8;}
                  else{
                    if(partes[0]==='I'){return 9;}
                    else{
                      if(partes[0]==='J'){return 10;}
                      else{
                        if(partes[0]==='K'){return 11;}
                        else{return 12;
                        }
                      }
                    }
  ...
  recuperarFechaCampo(edad){
    if(edad==1){return this.formDatos_TestPeruano.value.f1;}
    else{if(edad==2){return this.formDatos_TestPeruano.value.f2;}
      else {if (edad== 3) {return this.formDatos_TestPeruano.value.f3;}
        else {if (edad== 4) {return this.formDatos_TestPeruano.value.f4;}
          else{if(edad==5){return this.formDatos_TestPeruano.value.f5;}
            else{if(edad==6){return this.formDatos_TestPeruano.value.f6;}
              else{if(edad==7){return this.formDatos_TestPeruano.value.f7;}
                else{if(edad==8){return this.formDatos_TestPeruano.value.f8;}
                  else{if(edad==9){return this.formDatos_TestPeruano.value.f9;}
                    else{if(edad==10){return this.formDatos_TestPeruano.value.f10;}
                      else{if(edad==11){return  this.formDatos_TestPeruano.value.f11;}
                        else{if(edad==12){return this.formDatos_TestPeruano.value.f12;}
                          else{if(edad==15){return this.formDatos_TestPeruano.value.f15;}
                            else{if(edad==18){return  this.formDatos_TestPeruano.value.f18;}
                              else{if(edad==21){return this.formDatos_TestPeruano.value.f21;}
                                else{if(edad==24){return this.formDatos_TestPeruano.value.f24;}
                                  else{return this.formDatos_TestPeruano.value.f30;}
                                }
                              }
                            }
                          }
