...
import { AntecedentesService } from "src/app/cred/citas/atencion-cred/plan/services/antecedentes/antecedentes.service";
...
export class CrecimientoEstadoNutricionalComponent implements OnInit {
    ...
    guardar() {
        ...
        let aux1: interfaceCrecimiento = {
            ...
            estadoAplicado: true,
            fechaTentativa: this.datePipe.transform(
                this.auxInterface.fechaTentativa,
                "yyyy-MM-dd"
            ),
    ...
    onCircumferenceChart(): void {
        ...
        this.ref = this.dialogService.open(CircumferenceChartComponent, {
            ...
            header: isBoy
                ? "GRÁFICO DEL PERIMETRO CEFÁLICO DE UN NIÑO"
                : "GRÁFICO DEL PERIMETRO CEFÁLICO DE UNA NIÑA",
            // width: '90%',
            height: "90%",
            width: "70%",
            style: {
