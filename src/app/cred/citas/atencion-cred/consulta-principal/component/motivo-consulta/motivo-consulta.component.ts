...
export class MotivoConsultaComponent implements OnInit {
  ...
  recuperarMotivos() {
    ...
    this.motivosService.getMotivos(this.data.idConsulta).subscribe((r: any) => {
      ...
      this.examFG
        .get("PSFC")
        .setValue(this.motivosConsulta.signosVitales.presionSistolica);
      this.examFG
        .get("PDFC")
        .setValue(this.motivosConsulta.signosVitales.presionDiastolica);
      ...
      this.examFG
        .get("PCFC")
        .setValue(this.motivosConsulta.signosVitales.perimetroCefalico);
      this.examFG
        .get("detailFC")
      ...
      if (this.motivosConsulta.examenesFisicos !== null) {
        this.formExam
          .get("piel")
          .setValue(this.motivosConsulta.examenesFisicos[0].valor);
        this.formExam
          .get("cabeza")
          .setValue(this.motivosConsulta.examenesFisicos[1].valor);
        this.formExam
          .get("cara")
          .setValue(this.motivosConsulta.examenesFisicos[2].valor);
        this.formExam
          .get("cuello")
          .setValue(this.motivosConsulta.examenesFisicos[3].valor);
        this.formExam
          .get("torax")
          .setValue(this.motivosConsulta.examenesFisicos[4].valor);
        this.formExam
          .get("abdomen")
          .setValue(this.motivosConsulta.examenesFisicos[5].valor);
        this.formExam
          .get("columnaVert")
          .setValue(this.motivosConsulta.examenesFisicos[6].valor);
        this.formExam
          .get("extremidades")
          .setValue(this.motivosConsulta.examenesFisicos[7].valor);
        this.formExam
          .get("genitouriano")
          .setValue(this.motivosConsulta.examenesFisicos[8].valor);
        this.formExam
          .get("ano")
          .setValue(this.motivosConsulta.examenesFisicos[9].valor);
        this.formExam
          .get("obsExamenFisico")
      ...
      if (this.motivosConsulta.examenNeurologico !== null) {
        this.formExamNeurologico
          .get("olfatorio")
          .setValue(this.motivosConsulta.examenNeurologico[0].valor);
        this.formExamNeurologico
          .get("optico")
          .setValue(this.motivosConsulta.examenNeurologico[1].valor);
        this.formExamNeurologico
          .get("oculomotores")
          .setValue(this.motivosConsulta.examenNeurologico[2].valor);
        this.formExamNeurologico
          .get("trigemino")
          .setValue(this.motivosConsulta.examenNeurologico[3].valor);
        this.formExamNeurologico
          .get("facial")
          .setValue(this.motivosConsulta.examenNeurologico[4].valor);
        this.formExamNeurologico
          .get("auditivo")
          .setValue(this.motivosConsulta.examenNeurologico[5].valor);
        this.formExamNeurologico
          .get("glosoNeumo")
          .setValue(this.motivosConsulta.examenNeurologico[6].valor);
        this.formExamNeurologico
          .get("espinal")
          .setValue(this.motivosConsulta.examenNeurologico[7].valor);
        this.formExamNeurologico
          .get("hipogloso")
          .setValue(this.motivosConsulta.examenNeurologico[8].valor);
        this.formExamNeurologico
    ...
    let req: motivoConsultaInterface = {
      ...
      examenNeurologico: this.examenNeurologico.map((element) => {
        return {
          ...
          nombreExamen: element.codigo,
          valor:
            this.formExamNeurologico.get(element.nombreForm).value === null
              ? ""
              : this.formExamNeurologico.get(element.nombreForm).value,
        };
      }),
