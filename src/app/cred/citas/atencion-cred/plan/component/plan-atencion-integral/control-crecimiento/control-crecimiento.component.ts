...
} from '../../../../consulta-principal/component/evaluaciones-consulta/services/control-crecimiento/control-crecimiento.service'
...
import {dato, interfaceCrecimiento, SignosVitales} from "../../../../../models/data";
...
export class ControlCrecimientoComponent implements OnInit, DoCheck {
    ...
    separacion() {
        ...
        this.MA = this.aux.filter(item => item.descripcionEdad === 'Menor_1A')
