...
export class ModalCupos2Component implements OnInit {
            ...
            if (this.dataSelectServicio == "OBSTETRICIA") {
              if (
                ...
                this.formPacientesCupo
                  ...
                  .setValue(
                    this.obtenerFecha(
                      this.dataPacientes.nacimiento.fechaNacimiento
                    )
                  );
                this.formPacientesCupo
                  .get("estadoCivil")
                ...
                this.formPacientesCupo
                  .get("dpto")
                  .setValue(this.dataPacientes.domicilio.departamento);
                this.formPacientesCupo
                  .get("prov")
                  .setValue(this.dataPacientes.domicilio.provincia);
                this.formPacientesCupo
                  .get("dist")
                  .setValue(this.dataPacientes.domicilio.distrito);
                this.formPacientesCupo
                  .get("ccpp")
                  .setValue(this.dataPacientes.domicilio.ccpp);
                this.formPacientesCupo
                  .get("direccion")
                  .setValue(this.dataPacientes.domicilio.direccion);
                this.formPacientesCupo
                  .get("tipoSeguro")
                  .setValue(this.dataPacientes.tipoSeguro);
                this.formPacientesCupo
                ...
                this.formPacientesCupo
                  ...
                  .setValue(
                    this.dataPacientes.nacimiento.departamento +
                      " " +
                      this.dataPacientes.nacimiento.provincia +
                      " " +
              ...
              this.calcularEdad(
                this.obtenerFecha(this.dataPacientes.nacimiento.fechaNacimiento)
              );
              this.formPacientesCupo.get("edadAnio").setValue(this.edad);
              this.formPacientesCupo.get("edadMes").setValue(this.meses);
              this.formPacientesCupo.get("edadDia").setValue(this.dias);
  ...
  saveForm() {
    const req = {
      ...
      transeunte:
        this.formPacientesCupo.value.transeunte == "TRANSEUNTE" ? true : false,
  ...
  calcularEdad(fecha) {
    ...
    if (ahora_mes > mes && dia > ahora_dia) this.meses = ahora_mes - mes - 1;
    else if (ahora_mes > mes) this.meses = ahora_mes - mes;
    if (ahora_mes < mes && dia < ahora_dia) this.meses = 12 - (mes - ahora_mes);
    ...
    return (
      this.edad + " años, " + this.meses + "meses y " + this.dias + " días"
    );
  }
