...
export class TipoPersonalService {
    ...
    getTipoPersonales() {
        ...
        return this.http.get(`${this.base_url}/${this.bd}/tipopersonal`);
    }

    getTipoPersonal(id: string) {
        return this.http.get(`${this.base_url}/${this.bd}/tipopersonal/${id}`);
    }

    addTipoPersonal(personal: any) {
        return this.http.post(
            `${this.base_url}/${this.bd}/tipopersonal`,
            personal
        );
    }
    ...
    deleteTipoPersonal(id: string) {
        return this.http.delete(
            `${this.base_url}/${this.bd}/tipopersonal/${id}`
        );
    }
}
